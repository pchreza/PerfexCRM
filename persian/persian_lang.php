...
$lang['customer_active_inactive_help']                      = 'هنگام ایجاد رکورد جدید، در منوهای کشویی نمایش داده نمی‌شود';
$lang['item_groups']                                        = 'گروه‌ها';
$lang['item_group']                                         = 'گروه آیتم';
$lang['item_group_name']                                    = 'نام گروه';
$lang['new_item_group']                                     = 'گروه جدید';
$lang['show_setup_menu_item_only_on_hover']                 = 'نمایش آیتم منوی تنظیمات فقط زمانی که موس روی نوار کناری اصلی قرار گیرد';
$lang['internal_article']                                   = 'مقاله داخلی';
$lang['expenses_created_from_this_recurring_expense']       = 'هزینه‌های ایجاد شده از این هزینه تکراری';
$lang['convert_to_task']                                    = 'تبدیل به وظیفه';
$lang['next_invoice_date']                                  = 'تاریخ فاکتور بعدی: %s';
$lang['next_expense_date']                                  = 'تاریخ هزینه بعدی: %s';
$lang['invoice_recurring_from']                             = 'این فاکتور از فاکتور تکراری با شماره: %s ایجاد شده است';
$lang['expense_recurring_from']                             = 'این هزینه از هزینه تکراری زیر ایجاد شده است: %s';
$lang['child_invoices']                                     = 'فاکتورهای فرعی';
$lang['child_expenses']                                     = 'هزینه‌های فرعی';
$lang['no_announcements']                                   = 'بدون اطلاعیه';
$lang['unit']                                               = 'واحد';
$lang['permission_view_own']                                = 'دسترسی مشاهده (مربوط به خود)';
$lang['permission_global']                                  = 'دسترسی جهانی';
$lang['permission_customers_based_on_admins']               = 'بر اساس مدیران مشتریان';
$lang['permission_payments_based_on_invoices']              = 'بر اساس فاکتورها، دسترسی مشاهده (مربوط به خود)';
$lang['permission_projects_based_on_assignee']              = 'اگر عضو پرسنل دسترسی مشاهده (سطح جهانی) نداشته باشد، تنها پروژه‌هایی که عضو پرسنل در آن‌ها عضو شده نمایش داده می‌شود';
$lang['permission_tasks_based_on_assignee']                 = 'اگر عضو پرسنل دسترسی مشاهده (سطح جهانی) نداشته باشد، تنها وظایفی که عضو پرسنل در آن‌ها دنبال‌کننده یا اختصاص داده شده است، یا وظایف عمومی یا در تنظیمات پیشرفته مرتبط با پروژه‌ها به همه پرسنل اجازه دیده شدن داده شده باشد، نمایش داده می‌شود';
$lang['settings_paymentmethod_default_selected_on_invoice'] = 'به صورت پیش‌فرض در فاکتور انتخاب شود';
$lang['paymentmethod_braintree_merchant_id']                = 'شناسه تاجر (Merchant ID)';
$lang['paymentmethod_braintree_private_key']                = 'کلید خصوصی';
$lang['paymentmethod_braintree_public_key']                 = 'کلید عمومی';
$lang['company_requires_vat_number_field']                  = 'شرکت نیاز به استفاده از فیلد شماره مالیات بر ارزش افزوده (VAT)';
...
$lang['file_date_uploaded']                                 = 'تاریخ آپلود فایل';
$lang['allow_contact_to_delete_files']                      = 'اجازه به مخاطب برای حذف فایل‌های خود از ناحیه مشتری';
$lang['file']                                               = 'فایل';
$lang['customer_contact_person_only_one_allowed']           = 'فقط یک مخاطب مجاز است وقتی فیلد شرکت پر نشده باشد. سیستم این مشتری را به عنوان شخص در نظر می‌گیرد';
$lang['web_to_lead']                                        = 'وب به لید';
$lang['web_to_lead_form']                                   = 'فرم وب به لید';
$lang['new_form']                                           = 'فرم جدید';
$lang['form_name']                                          = 'نام فرم';
$lang['cf_option_in_use']                                   = 'گزینه‌ای که حذف کرده‌اید در حال استفاده است و نمی‌توان آن را حذف کرد. این گزینه به صورت خودکار به گزینه‌های موجود افزوده می‌شود';
$lang['form_builder']                                       = 'سازنده فرم';
$lang['form_information']                                   = 'اطلاعات و تنظیمات فرم';
$lang['form_builder_create_form_first']                     = 'ابتدا فرم را ایجاد کنید تا بتوانید از سازنده فرم استفاده کنید';
$lang['notify_assigned_user']                               = 'مسئول مربوطه';
...
$lang['form_success_submit_msg']                            = 'پیامی که پس از ارسال موفقیت‌آمیز فرم نمایش داده می‌شود';
$lang['total_submissions']                                  = 'تعداد کل ارسال‌ها';
$lang['form_integration_code']                              = 'کد یکپارچه‌سازی';
$lang['not_lead_imported_from_form']                        = 'لید جدید از فرم وب به لید وارد شده است - %s';
$lang['not_lead_activity_log_attachment']                   = 'پیوند وارد شده از فرم - %s';
$lang['form_integration_code_help']                         = 'کد را کپی کرده و در هر جایی از سایت خود برای نمایش فرم قرار دهید. علاوه بر این، می‌توانید عرض و ارتفاع px را برای تطبیق با وب‌سایت خود تنظیم کنید.';
$lang['invoice_not_found']                                  = 'فاکتور پیدا نشد';
$lang['estimate_not_found']                                 = 'برآورد پیدا نشد';
$lang['expense_not_found']                                  = 'هزینه پیدا نشد';
$lang['proposal_not_found']                                 = 'پیشنهاد پیدا نشد';
$lang['new_task_assigned_non_user']                         = 'وظیفه جدید به شما اختصاص داده شد - %s';
$lang['no_child_found']                                     = 'هیچ زیرمجموعه‌ای از %s پیدا نشد';
$lang['company_vat_number']                                 = 'شماره مالیات بر ارزش افزوده (VAT)';
$lang['not_lead_assigned_from_form']                        = 'لید جدید به شما اختصاص داده شد';
$lang['not_lead_activity_assigned_from_form']               = 'لید به %s اختصاص داده شد';
$lang['form_allow_duplicate']                               = 'آیا اجازه داده می‌شود %s تکراری به پایگاه داده وارد شود؟';
$lang['track_duplicate_by_field']                           = 'جلوگیری از تکرار بر اساس فیلد';
$lang['and_track_duplicate_by_field']                       = '+ فیلد (برای ردیابی تکراری‌ها فقط از یک فیلد، فیلد را خالی بگذارید)';
$lang['create_the_duplicate_form_data_as_task']             = 'ایجاد داده‌های فرم تکراری به عنوان وظیفه و اختصاص به عضو مسئول';
$lang['create_the_duplicate_form_data_as_task_help']        = 'برای بررسی بیشتر ارسال و انجام اقدامات لازم استفاده می‌شود';
$lang['currently_selected']                                 = 'انتخاب شده فعلی';
$lang['search_ajax_empty']                                  = 'انتخاب کرده و شروع به تایپ کنید';
...
$lang['invoice_activity_auto_converted_from_estimate']      = 'فاکتور به طور خودکار از برآورد با شماره %s ایجاد شد';
$lang['hour_of_day_perform_auto_operations']                = 'ساعت روز برای انجام عملیات خودکار';
$lang['hour_of_day_perform_auto_operations_format']         = 'فرمت 24 ساعته مانند 9 برای 9 صبح یا 15 برای 3 عصر';
$lang['inv_hour_of_day_perform_auto_operations_help']       = 'برای فاکتورهای تکراری، اطلاعیه‌های معوقه و غیره استفاده می‌شود';
$lang['use_minified_files']                                 = 'استفاده از نسخه‌های فشرده فایل‌های css و js (فقط فایل‌های سیستمی)';

# Version 1.5.0
$lang['logo_favicon_changed_notice']       = 'تغییر لوگو یا فاویکون شناسایی شد. اگر هنوز لوگوی اصلی CRM را مشاهده می‌کنید، لطفاً کش مرورگر خود را پاک کنید.';
...
$lang['cf_translate_input_link_url']       = 'آدرس اینترنتی (URL)';
$lang['cf_translate_input_link_tip']       = 'برای افزودن لینک اینجا کلیک کنید';
$lang['task_edit_delete_timesheet_notice'] = 'وظیفه تایم‌شییت %s است و شما نمی‌توانید تایم‌شییت را %s کنید.';
$lang['department_username']               = 'نام‌کاربری IMAP';
$lang['department_username_help']          = 'این فیلد را فقط زمانی پر کنید که سرور IMAP شما برای ورود از نام‌کاربری به جای آدرس ایمیل استفاده می‌کند. توجه داشته باشید که هنوز باید آدرس ایمیل را اضافه کنید.';
$lang['total_tickets_deleted']             = 'تعداد کل تیکت‌های حذف‌شده: %s';

# Version 1.5.1
$lang['ticket_linked_to_project']                                = 'این تیکت به پروژه لینک شده است: %s';
$lang['only_own_files_contacts']                                 = 'مخاطبان تنها فایل‌های خود را که در ناحیه مشتری بارگذاری شده‌اند مشاهده می‌کنند (فایل‌های بارگذاری شده در پروفایل مشتری)';
$lang['only_own_files_contacts_help']                            = 'اگر فایل را به صورت دستی از پروفایل مشتری به مخاطبان دیگر به اشتراک بگذارید، آنها قادر به مشاهده فایل خواهند بود.';
$lang['share_file_with']                                         = 'به اشتراک‌گذاری فایل با';
$lang['file_share_visibility_notice']                            = 'این فایل با مخاطبان به اشتراک گذاشته نشده است، مجدداً برای بارگذاری مجدد قابل مشاهده بودن را تغییر دهید';
$lang['share_file_with_show']                                    = 'این فایل با %s به اشتراک گذاشته شده است';
$lang['allow_primary_contact_to_view_edit_billing_and_shipping'] = 'اجازه به مخاطب اصلی برای مشاهده/ویرایش جزئیات صورتحساب و ارسال';

# Version 1.6.0
$lang['my_timesheets']                                   = 'تایم‌شییت‌های من';
$lang['today']                                           = 'امروز';
$lang['open_in_dropbox']                                 = 'باز کردن در Dropbox';
$lang['show_primary_contact']                            = 'نمایش نام کامل مخاطب اصلی در %s';
$lang['view_members_timesheets']                         = 'مشاهده تمامی تایم‌شییت‌ها';
$lang['priority']                                        = 'اولویت';
$lang['fetch_from_google']                               = 'استخراج از گوگل';
$lang['customer_fetch_lat_lng_usage']                    = 'قبل از استخراج آدرس، شهر و کشور را وارد کنید تا بهترین نتیجه بدست آید.';
$lang['g_search_address_not_found']                      = 'آدرس پیدا نشد، لطفاً دوباره تلاش کنید';
$lang['proposals_report']                                = 'گزارش پیشنهادات';
$lang['staff_members_open_tickets_to_all_contacts_help'] = 'اگر عضو پرسنل دسترسی مشاهده مشتریان را نداشته باشد، فقط قادر خواهد بود از بخش مدیریت تیکت‌های جدید برای مخاطبانی که به عنوان مدیر مشتری منصوب شده‌اند، ایجاد کند.';
$lang['staff_members_open_tickets_to_all_contacts']      = 'آیا به اعضای پرسنل اجازه می‌دهید که تیکت به تمامی مخاطبان ایجاد کنند؟';
...
$lang['default_view']                                    = 'نمایش پیش‌فرض';
$lang['day']                                             = 'روز';
$lang['agenda']                                          = 'برنامه';
$lang['timesheet_tags']                                  = 'برچسب‌های تایم‌شییت';
$lang['show_more']                                       = 'نمایش بیشتر';
$lang['show_less']                                       = 'نمایش کمتر';
$lang['project_completed_date']                          = 'تاریخ تکمیل پروژه';
$lang['language']                                        = 'زبان';
$lang['this_week']                                       = 'این هفته';
$lang['last_week']                                       = 'هفته گذشته';
$lang['this_month']                                      = 'این ماه';
$lang['last_month']                                      = 'ماه گذشته';
$lang['no_description_project']                          = 'توضیحی برای این پروژه موجود نیست';
$lang['sales_string']                                    = 'فروش';
$lang['no_project_members']                              = 'هیچ عضوی برای این پروژه وجود ندارد';
$lang['search_by_tags']                                  = 'برای جستجو از # و نام برچسب استفاده کنید';
...
$lang['recurring_invoice_draft_notice']           = 'این فاکتور در وضعیت پیش‌نویس است، شما باید این فاکتور را به عنوان ارسال شده علامت‌گذاری کنید. فاکتورهای دوره‌ای با وضعیت پیش‌نویس توسط کرون جاب مجدداً ایجاد نمی‌شوند.';
$lang['recurring_recreate_hour_notice']           = '%s در ساعت مشخصی از روز طبق تنظیمات موجود در Setup->Settings-Cron Job مجدداً ایجاد خواهد شد';
$lang['invoice_project_include_timesheets_notes'] = 'شامل هر یادداشت تایم‌شییت در توضیحات آیتم';
$lang['events']                                   = 'رویدادها';
$lang['clear']                                    = 'پاک کردن';
$lang['auto_mark_as_public']                      = 'به طور خودکار به حالت عمومی علامت‌گذاری شود';
$lang['time_format']                              = 'فرمت زمان';
$lang['time_format_24']                           = '24 ساعته';
$lang['time_format_12']                           = '12 ساعته';
$lang['delete_activity_log_older_then']           = 'حذف لاگ فعالیت سیستم قدیمی‌تر از X ماه';
...
$lang['new_task_auto_assign_current_member']      = 'به طور خودکار وظیفه را به سازنده وظیفه اختصاص بده';
$lang['new_task_auto_assign_current_member_help'] = 'در صورتی که وظیفه به پروژه مرتبط باشد و سازنده وظیفه عضو پروژه نباشد، اعمال نمی‌شود';
$lang['copy_project_tasks_status']                = 'وضعیت وظایف';
$lang['tasks_summary']                            = 'خلاصه وظایف';
$lang['vault']                                    = 'خزانه';
$lang['new_vault_entry']                          = 'ورودی جدید خزانه';
$lang['server_address']                           = 'آدرس سرور';
$lang['port']                                     = 'پورت';
$lang['vault_username']                           = 'نام‌کاربری';
$lang['vault_password']                           = 'رمز عبور';
$lang['vault_description']                        = 'توضیحات کوتاه';
$lang['vault_entry']                              = 'ورودی خزانه';
$lang['no_port_provided']                         = 'ارائه نشده';
$lang['view_password']                            = 'مشاهده رمز عبور';
$lang['security_reasons_re_enter_password']       = 'به دلایل امنیتی لطفاً رمز عبور خود را وارد کنید';
$lang['password_change_fill_notice']              = 'فقط در صورتی که می‌خواهید رمز عبور را تغییر دهید، فیلد رمز عبور را پر کنید';
$lang['vault_password_user_not_correct']          = 'رمز عبور شما صحیح نیست، لطفاً دوباره تلاش کنید';
$lang['no_vault_entries']                         = 'ورودی‌های خزانه برای این مشتری یافت نشد';
$lang['vault_entry_created_from']                 = 'این ورودی خزانه توسط %s ایجاد شده است';
$lang['vault_entry_last_update']                  = 'آخرین بروزرسانی توسط %s';
$lang['vault_entry_visible_to_all']               = 'برای تمام اعضای پرسنل که به این مشتری دسترسی دارند قابل مشاهده است';
$lang['vault_entry_visible_creator']              = 'فقط برای من (مدیران شامل نمی‌شوند)';
...
$lang['event_notification']                       = 'اطلاع‌رسانی رویداد';
$lang['days']                                     = 'روزها';
$lang['reminder_notification_placeholder']        = 'مثال: 30 دقیقه قبل';
...
# Version 1.8.0
$lang['not_customer_viewed_invoice']                         = 'صورتی با شماره %s مشاهده شده است';
$lang['not_customer_viewed_estimate']                        = 'برآورد با شماره %s مشاهده شده است';
$lang['not_customer_viewed_proposal']                        = 'پیشنهاد با شماره %s مشاهده شده است';
$lang['display_inline']                                      = 'نمایش درون خطی';
$lang['email_header']                                        = 'سربرگ از پیش تعریف شده';
$lang['email_footer']                                        = 'پاورقی از پیش تعریف شده';
$lang['exclude_proposal_from_client_area_with_draft_status'] = 'حذف پیشنهادات با وضعیت پیش نویس از ناحیه مشتری';
$lang['pusher_app_key']                                      = 'کد اپلیکیشن';
$lang['pusher_app_secret']                                   = 'رمز اپلیکیشن';
$lang['pusher_app_id']                                       = 'شناسه اپلیکیشن';
$lang['pusher_cluster_notice']                               = 'برای استفاده از خوشه پیش فرض pusher این قسمت را خالی بگذارید.';
$lang['pusher_enable_realtime_notifications']                = 'فعال کردن اعلان‌های لحظه‌ای';
$lang['task_is_overdue']                                     = 'این وظیفه معوقه است';
$lang['this_year']                                           = 'امسال';
$lang['last_year']                                           = 'سال گذشته';
$lang['customer_statement']                                  = 'صورت حساب';
$lang['customer_statement_for']                              = 'صورت حساب مشتری برای %s';
$lang['account_summary']                                     = 'خلاصه حساب';
$lang['statement_beginning_balance']                         = 'تعادل ابتدایی';
$lang['invoiced_amount']                                     = 'مبلغ فاکتور';
$lang['amount_paid']                                         = 'مبلغ پرداختی';
...
$lang['statement_invoice_details']                           = 'فاکتور %s - تاریخ سررسید %s';
...
$lang['statement_sent_to_client_fail']                       = 'مشکلی در ارسال صورت حساب پیش آمد';
$lang['view_account_statement']                              = 'مشاهده صورت حساب';
$lang['text_not_recommended_for_servers_limited_resources']  = 'برای سرورهایی با منابع محدود توصیه نمی‌شود. مانند هاست اشتراکی';
$lang['tasks_bull_actions_assign_notice']                    = 'اگر وظیفه به پروژه‌ای مرتبط باشد و فردی که می‌خواهید وظیفه را به او اختصاص دهید عضو پروژه نباشد، این فرد به صورت خودکار به عنوان عضو پروژه اضافه خواهد شد.';
...
$lang['ticket_form_service']                                 = 'خدمات';
$lang['ticket_form_submit']                                  = 'ارسال';
$lang['ticket_form_attachments']                             = 'پیوست‌ها';

$lang['success_submit_msg']                       = 'ممنون از تماس شما. ما به زودی با شما تماس خواهیم گرفت.';
$lang['vault_entry_share_on_projects']            = 'این ورودی مخزن را در پروژه‌ها با اعضای پروژه به اشتراک بگذارید';
$lang['project_shared_vault_entry_login_details'] = 'مشاهده جزئیات ورود به سایت مشتری';
$lang['iso_code']                                 = 'کد ISO';
$lang['estimates_not_invoiced']                   = 'پرداخت نشده';
$lang['show_on_ticket_form']                      = 'نمایش در فرم تیکت';
$lang['cancel_upload']                            = 'لغو آپلود';
$lang['show_table_export_button']                 = 'نمایش دکمه صادر کردن جدول';
$lang['show_table_export_all']                    = 'برای تمام اعضای تیم';
$lang['show_table_export_admins']                 = 'فقط برای مدیران';
$lang['show_table_export_hide']                   = 'مخفی کردن دکمه صادر کردن برای تمام اعضای تیم';
$lang['task_created_by']                          = 'ایجاد شده توسط %s';
$lang['validation_extension_not_allowed']         = 'افزونه فایل مجاز نیست';
$lang['allow_staff_view_proposals_assigned']      = 'اجازه بدهید اعضای تیم پیشنهادات مربوط به خود را مشاهده کنند';
$lang['task_users_working_on_tasks_multiple']     = 'در حال حاضر %s نفر در حال انجام این وظیفه هستند';
$lang['task_users_working_on_tasks_single']       = 'در حال حاضر %s نفر در حال انجام این وظیفه است';

# Version 1.9.0
$lang['estimated_hours']                               = 'ساعات تخمینی';
$lang['two_factor_auth_failed_to_send_code']           = 'ارسال کد احراز هویت دو مرحله‌ای به ایمیل موفق نبود، تنظیمات SMTP ممکن است به درستی پیکربندی نشده باشند';
$lang['two_factor_auth_code_sent_successfully']        = 'یک ایمیل به آدرس %s با کد تأیید ارسال شده است تا ورود شما تأیید شود';
$lang['enable_two_factor_authentication']              = 'فعال کردن احراز هویت دو مرحله‌ای';
$lang['two_factor_authentication_info']                = 'احراز هویت دو مرحله‌ای از طریق ایمیل ارائه می‌شود. قبل از فعال کردن احراز هویت دو مرحله‌ای، اطمینان حاصل کنید که تنظیمات SMTP شما به درستی پیکربندی شده باشد و سیستم قادر به ارسال ایمیل باشد. کد احراز هویت منحصر به فرد پس از ورود به ایمیل شما ارسال خواهد شد.';
$lang['timesheets_overview_all_members_notice_admins'] = 'نمای کلی تایم‌شیت برای تمام اعضای تیم فقط برای مدیران در دسترس است.';
...
$lang['enter_activity']                                = 'وارد کردن فعالیت';
...
$lang['modal_width_class']                             = 'کلاس عرض مدال';
$lang['contract_copy']                                 = 'کپی';
$lang['contract_copied_successfully']                  = 'قرارداد با موفقیت کپی شد';
$lang['contract_copied_fail']                          = 'کپی قرارداد موفقیت‌آمیز نبود';
...
$lang['project_setting_edit_tasks']                    = 'ویرایش وظایف (فقط وظایفی که از طریق مخاطب ایجاد شده‌اند)';

# Version 1.9.2
$lang['items_report']                            = 'آیتم های گزارش';
$lang['reports_item']                            = 'آیتم';
$lang['quantity_sold']                           = 'مقدار فروخته‌شده';
$lang['total_amount']                            = 'مجموع مبلغ';
$lang['avg_price']                               = 'میانگین قیمت';
$lang['item_report_paid_invoices_notice']        = 'گزارش آیتم‌ها فقط از فاکتورهای پرداخت‌شده قبل از تخفیف‌ها و مالیات‌ها تولید می‌شود.';
$lang['overview']                                = 'مرور کلی';
$lang['timer_started_change_status_in_progress'] = 'تغییر وضعیت وظیفه به "در حال انجام" هنگام شروع تایمر (فقط در صورتی که وضعیت وظیفه "شروع نشده" باشد)';
$lang['company_info_format']                     = 'فرمت اطلاعات شرکت (PDF و HTML)';
$lang['customer_info_format']                    = 'فرمت اطلاعات مشتری (PDF و HTML)';
$lang['custom_field_info_format_embed_info']     = 'فیلدهای سفارشی برای %s را می‌توان به راحتی در اسناد PDF و HTML با افزودن فیلدهای ترکیب به فرمت صفحه در صفحه زیر جاسازی کرد: %s';
$lang['transfer_lead_notes_to_customer']         = 'انتقال یادداشت‌های لید به پروفایل مشتری';
$lang['authorized_signature_text']               = 'امضای مجاز';
$lang['show_pdf_signature_invoice']              = 'نمایش امضای PDF در فاکتور';
$lang['show_pdf_signature_estimate']             = 'نمایش امضای PDF در برآورد';
$lang['signature']                               = 'امضا';
$lang['signature_image']                         = 'تصویر امضا';
$lang['insert_checklist_templates']              = 'اضافه کردن الگوهای چک‌لیست';
$lang['save_as_template']                        = 'ذخیره به عنوان الگو';
$lang['invoice_item_add_edit_rate_currency']     = 'نرخ - %s';
$lang['total_files_deleted']                     = 'مجموع فایل‌های حذف‌شده: %s';
$lang['invalid_transaction']                     = 'معامله نامعتبر. لطفاً دوباره تلاش کنید.';
$lang['payment_gateway_payu_money_key']          = 'کلید PayU Money';
$lang['payment_gateway_payu_money_salt']         = 'نمک PayU Money';
$lang['settings_paymentmethod_description']      = 'توضیحات داشبورد درگاه پرداخت';


# Version 1.9.3
$lang['default_ticket_reply_status']          = 'وضعیت پیش‌فرض انتخاب شده هنگام پاسخ به تیکت';
$lang['ticket_add_response_and_back_to_list'] = 'بازگشت به لیست تیکت‌ها پس از ارسال پاسخ';

# Version 1.9.4
$lang['default_task_status']                               = 'وضعیت پیش‌فرض هنگام ایجاد کار جدید';
$lang['custom_field_pdf_html_help']                        = 'اطمینان حاصل کنید که فیلد ' . $lang['custom_field_show_on_client_portal'] . ' را بررسی کرده‌اید اگر می‌خواهید فیلدهای سفارشی در ناحیه مشتری قابل مشاهده باشند و هنگام دانلود یا دریافت PDF توسط مشتری نمایش داده شوند.';
$lang['auto']                                              = 'اتوماتیک';
$lang['email_queue']                                       = 'صف ایمیل';
$lang['email_queue_enabled']                               = 'فعال‌سازی صف ایمیل';
$lang['email_queue_skip_attachments']                      = 'ایمیل‌های با پیوست را در صف قرار ندهید.';
$lang['disable']                                           = 'غیرفعال';
$lang['enable']                                            = 'فعال';
$lang['auto_dismiss_desktop_notifications_after']          = 'بستن خودکار اطلاعیه‌های دسکتاپ پس از X ثانیه (برای غیرفعال کردن 0 وارد کنید)';
$lang['proposal_info_format']                              = 'فرمت اطلاعات پیشنهاد (PDF و HTML)';
$lang['hide_tasks_on_main_tasks_table']                    = 'پنهان کردن وظایف پروژه در جدول وظایف اصلی (منطقه مدیر)';
$lang['ticket_replies_order']                              = 'ترتیب پاسخ‌های تیکت';
$lang['ticket_replies_order_notice']                       = 'پیام اولیه تیکت همیشه به عنوان اولین نمایش داده خواهد شد.';
$lang['invoice_cancelled_email_disabled']                  = 'فاکتور لغو شده است. برای فعال‌سازی ارسال ایمیل به مشتری، لغو را از وضعیت لغو خارج کنید.';
$lang['email_notifications']                               = 'اطلاعیه‌های ایمیلی';
$lang['invoice_activity_record_payment_email_to_customer'] = 'پرداخت ثبت شد، ایمیل به مشتری ارسال شد به: %s';
$lang['exclude_inactive']                                  = 'حذف موارد غیرفعال';
...
# Version 1.9.5
$lang['customers_assigned_to_me']              = 'مشتریان واگذار شده به من';
$lang['bcc_all_emails']                        = 'ارسال BCC به همه ایمیل‌ها به';
$lang['confirmation_of_identity']              = 'تایید هویت';
$lang['accept_identity_confirmation']          = 'نیاز به تایید هویت در زمان پذیرش';
$lang['accepted_identity_info']                = 'این %s توسط %s در تاریخ %s از آدرس IP %s پذیرفته شد';
$lang['clear_this_information']                = 'حذف این اطلاعات';
$lang['new_task_auto_follower_current_member'] = 'اضافه کردن خودکار ایجادکننده کار به عنوان دنبال‌کننده کار زمانی که کار جدیدی ایجاد می‌شود';
$lang['expenses_report_net']                   = 'مقدار خالص (جمع جزئی)';
$lang['expense_field_billable_help']           = 'اگر قابل صدور فاکتور باشد، %s می‌تواند به توضیحات بلند فاکتور اضافه شود.';
$lang['task_biillable_checked_on_creation']    = 'آیا گزینه قابل صدور فاکتور به طور پیش‌فرض هنگام ایجاد کار جدید فعال است؟';
$lang['pause_overdue_reminders']               = 'معلق کردن یادآوری‌های سررسید گذشته';
$lang['resume_overdue_reminders']              = 'ادامه دادن یادآوری‌های سررسید گذشته';

# Credit Notes
$lang['credit_notes']                                            = 'یادداشت‌های اعتباری';
$lang['credit_note']                                             = 'یادداشت اعتباری';
$lang['credit_note_lowercase']                                   = 'یادداشت اعتباری';
$lang['credit_note_not_found']                                   = 'یادداشت اعتباری پیدا نشد';
$lang['credit_note_date']                                        = 'تاریخ یادداشت اعتباری';
$lang['credit_date']                                             = 'تاریخ';
$lang['settings_sales_next_credit_note_number']                  = 'شماره بعدی یادداشت اعتباری';
...
$lang['credit_note_remaining_credits']                           = 'اعتبارات باقی‌مانده';
$lang['credit_note_client_note']                                 = 'یادداشت';
$lang['invoices_credited']                                       = 'فاکتورها اعتبار داده شده';
$lang['apply_credits']                                           = 'اعمال اعتبارات';
$lang['x_credits_available']                                     = '%s اعتبار موجود.';
$lang['credit_amount']                                           = 'مقدار اعتبار';
$lang['credits_available']                                       = 'اعتبارات موجود';
$lang['amount_to_credit']                                        = 'مقدار برای اعتبار';
$lang['invoice_credits_applied']                                 = 'اعتبارات با موفقیت به فاکتور اعمال شد';
$lang['applied_credits']                                         = 'اعتبارات اعمال شده';
$lang['credit_amount_bigger_then_invoice_balance']               = 'مجموع اعتبار بیشتر از مانده فاکتور است';
$lang['credit_amount_bigger_then_credit_note_remaining_credits'] = 'مجموع اعتبار بیشتر از اعتبارات باقی‌مانده است';
$lang['credited_invoices_not_found']                             = 'فاکتورهای اعتبار داده شده پیدا نشد';
$lang['credit_invoice_number']                                   = 'شماره فاکتور';
$lang['credits_used']                                            = 'اعتبارات استفاده شده';
$lang['credits_remaining']                                       = 'اعتبارات باقی‌مانده';
$lang['amount_credited']                                         = 'مقدار اعتبار داده شده';
$lang['credits_applied_cant_delete_status_closed']               = 'این یادداشت اعتباری با وضعیت بسته است، ابتدا باید اعتبارات حذف شوند تا بتوانید یادداشت اعتباری را حذف کنید.';
$lang['credits_applied_cant_delete_credit_note']                 = 'این یادداشت اعتباری دارای اعتبارات اعمال شده است، ابتدا باید اعتبارات حذف شوند تا بتوانید یادداشت اعتباری را حذف کنید.';
$lang['credit_note_pdf_heading']                                 = 'یادداشت اعتباری';
$lang['show_status_on_pdf']                                      = 'نمایش وضعیت %s در اسناد PDF';
$lang['show_pdf_signature_credit_note']                          = 'نمایش امضا در PDF یادداشت اعتباری';
...
$lang['invoice_activity_applied_credits']                        = 'اعمال اعتبارات به مبلغ %s از %s';
$lang['create_credit_note']                                      = 'ایجاد یادداشت اعتباری';
$lang['confirm_invoice_credits_from_credit_note']                = 'هنگام ایجاد یادداشت اعتباری از فاکتور پرداخت نشده، مبلغ یادداشت اعتباری برای این فاکتور اعمال خواهد شد. آیا مطمئن هستید که می‌خواهید یادداشت اعتباری ایجاد کنید؟';
$lang['credit_invoice_date']                                     = 'تاریخ فاکتور';
$lang['apply_to_invoice']                                        = 'اعمال به فاکتور';
$lang['apply_credits_from']                                      = 'اعمال اعتبار از %s';
$lang['credits_successfully_applied_to_invoices']                = 'اعتبارات با موفقیت به فاکتورها اعمال شد';
...
$lang['credit_note_no_invoices_available']                       = 'فاکتوری برای این مشتری موجود نیست.';
...
$lang['show_amount_due_on_invoice']                              = 'نمایش مبلغ بدهی در فاکتور';
$lang['customer_profile_update_credit_notes']                    = 'به‌روزرسانی اطلاعات حمل و نقل/صورتحساب در تمام یادداشت‌های اعتباری قبلی (یادداشت‌های اعتباری بسته تأثیر نمی‌پذیرند)';
$lang['zip_credit_notes']                                        = 'فشرده‌سازی یادداشت‌های اعتباری';
$lang['statement_credit_note_details']                           = 'یادداشت اعتباری %s';
$lang['statement_credits_applied_details']                       = 'اعتبارات اعمال شده از یادداشت اعتباری %s - %s برای پرداخت مبلغ %s';
...
# Version 1.9.7
$lang['ticket_assigned']                          = 'منتسب شده';
...
$lang['user_widget']                              = 'ویجت کاربر';
$lang['widgets_visibility_help_text']             = 'ویجت‌هایی که تنها اگر داده کافی داشته باشند نمایش داده می‌شوند، گزینه‌ای برای پنهان یا نمایش ندارند.';
...
$lang['visible_tabs']                             = 'تب‌های قابل مشاهده';
$lang['all']                                      = 'همه';
$lang['view_widgetable_area']                     = 'نمایش ناحیه قابل ویجت';
$lang['hide_widgetable_area']                     = 'پنهان کردن ناحیه قابل ویجت';
$lang['no_items_warning']                         = 'لطفاً حداقل یک آیتم وارد کنید.';
$lang['item_forgotten_in_preview']                = 'آیا فراموش کرده‌اید که این آیتم را اضافه کنید؟';
$lang['not_task_status_changed']                  = '%s - وضعیت کار به %s تغییر کرد';
$lang['not_project_activity_task_status_changed'] = 'وضعیت کار تغییر کرد';
$lang['reset']                                    = 'بازنشانی';
$lang['save_message_as_predefined_reply']         = 'ذخیره پیام به عنوان پاسخ از پیش تعریف شده';
$lang['inline_create_option']                     = 'آیا به اعضای غیرمدیر اجازه می‌دهید تا %s را در ناحیه ایجاد/ویرایش %s ایجاد کنند؟';
$lang['inline_create']                            = 'ایجاد درون‌خطی';
$lang['inline_create_option_predefined_replies']  = 'آیا به اعضای غیرمدیر اجازه می‌دهید تا پاسخ‌های از پیش تعریف شده را از پیام‌های تیکت ذخیره کنند؟';
$lang['reminders_view_none_admin']                = 'نمایش یادآوری‌های شما و یادآوری‌هایی که توسط شما ایجاد شده‌اند.';
$lang['show_tabs_and_options']                    = 'نمایش تب‌ها و گزینه‌ها';
$lang['no_milestones_found']                      = 'این پروژه هیچ نقطه عطفی ندارد';
$lang['lead_is_contact_create_task']              = 'اگر فرستنده ایمیل قبلاً مشتری باشد، کار ایجاد کرده و به عضو مسئول ارجاع دهید.';
$lang['existing_customer']                        = 'مشتری موجود';
$lang['use_company_name_instead']                 = 'به جای آن از نام شرکت استفاده کنید';
$lang['customer_delete_transactions_warning']     = 'این مشتری تراکنش‌هایی دارد، %s، شما باید تراکنش‌ها را حذف کنید یا به مشتری دیگری منتقل کنید تا بتوانید این عملیات را انجام دهید.';

# Version 1.9.8
$lang['sending_email_contact_permissions_warning'] = 'عدم توانایی در انتخاب خودکار مخاطبین مشتری. اطمینان حاصل کنید که مشتری مخاطبین فعال داشته باشد و مخاطبین مربوطه ایمیل‌های اطلاع‌رسانی برای %s فعال داشته باشند.';
$lang['help_leads_create_permission']              = 'تمامی کارکنان می‌توانند لید ایجاد کنند، به جز اعضایی که به عنوان غیرکارمند علامت‌گذاری شده‌اند.';
$lang['help_leads_edit_permission']                = 'هر کسی که به یک لید خاص دسترسی داشته باشد می‌تواند بیشتر اطلاعات آن را ویرایش کند.';
$lang['triggers']                                  = 'محرک‌ها';
$lang['notice_only_one_active_sms_gateway']        = 'فقط 1 دروازه SMS فعال مجاز است.';
$lang['sms_trigger_disable_tip']                   = 'محتوا را خالی بگذارید تا محرک خاصی غیرفعال شود.';
$lang['tables']                                    = 'جداول';
$lang['only_project_tasks']                        = 'فقط وظایف مربوط به پروژه';
$lang['download_all']                              = 'دانلود همه';
$lang['settings_sales_credit_note_number_format']  = 'فرمت شماره یادداشت اعتباری';
$lang['sms_reminder_sent_to']                      = 'یادآوری SMS به %s ارسال شد.';
$lang['ideal_customer_statement_descriptor']       = 'توصیف صورت‌حساب (که در صورت‌حساب بانکی مشتری نمایش داده می‌شود)';
$lang['payment_received_awaiting_confirmation']    = 'پرداخت شما دریافت شده است و منتظر تأیید می‌باشد.';
$lang['discount_fixed_amount']                     = 'مقدار ثابت';
$lang['timesheet_duration_instead']                = 'مدت زمان را وارد کنید به جای آن';
$lang['timesheet_date_instead']                    = 'زمان شروع و پایان را تعیین کنید به جای آن';
$lang['allow_non_admin_members_to_import_leads']   = 'اجازه دهید اعضای غیرمدیر لیدها را وارد کنند';
$lang['project_hide_tasks_settings_info']          = 'وظایف از جدول اصلی وظایف برای این پروژه حذف شده‌اند، شما می‌توانید وظایف پروژه را فقط در این بخش مشاهده کنید.';

# Version 1.9.9
$lang['ticket_create_no_contact']            = 'تیکت بدون مخاطب';
$lang['ticket_create_to_contact']            = 'تیکت به مخاطب';
$lang['showing_billable_tasks_from_project'] = 'نمایش وظایف قابل فاکتور از پروژه';
$lang['no_billable_tasks_found']             = 'هیچ وظیفه‌ای برای فاکتور پیدا نشد';
$lang['help_leads_permission_view']          = 'اگر این مجوز تیک نخورد، یک عضو تیم فقط می‌تواند لیدهایی را مشاهده کند که به او اختصاص داده شده‌اند، لیدهایی که توسط عضو تیم ایجاد شده‌اند و لیدهایی که به عنوان عمومی علامت‌گذاری شده‌اند.';
...
$lang['emails_tracking']                                        = 'پیگیری ایمیل‌ها';
$lang['no_tracked_emails_sent']                                 = 'هیچ ایمیلی پیگیری نشده ارسال نشده است';
$lang['tracked_emails_sent']                                    = 'ایمیل‌های پیگیری شده ارسال شده';
...
$lang['accept_identity_confirmation_and_signature_sign']        = 'نیاز به امضای دیجیتال و تایید هویت در زمان پذیرش';
$lang['legal_bound_text']                                       = 'متن الزام‌آور قانونی';
$lang['e_signature_sign']                                       = 'امضا';
$lang['is_signed']                                              = 'امضا شده';
$lang['is_not_signed']                                          = 'امضا نشده';
$lang['download']                                               = 'دانلود';
$lang['view_pdf_in_new_window']                                 = 'مشاهده PDF در پنجره جدید';
...
$lang['document_signed_info']                                   = 'این سند توسط %s در تاریخ %s از IP آدرس %s امضا شده است';
...
$lang['contract_comments']                                      = 'نظرات قرارداد';
...
$lang['clear_signature']                                        = 'حذف امضا';
$lang['recurring_has_ended']                                    = 'این %s تکراری پایان یافته است.';
$lang['cycles_remaining']                                       = 'دوره‌های باقی‌مانده';
$lang['cycles_infinity']                                        = 'بی‌نهایت';
$lang['recurring_total_cycles']                                 = 'کل دوره‌ها';
$lang['cycles_passed']                                          = 'دوره‌های گذشته %s';
$lang['api_key_not_set_error_message']                          = 'کلید API تنظیم نشده است، لطفاً برای تنظیم کلید API روی لینک زیر کلیک کنید: %s';
$lang['subscription']                                           = 'اشتراک';
$lang['subscription_lowercase']                                 = 'اشتراک';
$lang['subscriptions']                                          = 'اشتراک‌ها';
$lang['tax_is_used_in_subscriptions_warning']                   = 'شما نمی‌توانید این مالیات را به‌روزرسانی کنید زیرا در اشتراک‌ها استفاده شده است.';
$lang['credit_card']                                            = 'کارت اعتباری';
$lang['update_credit_card']                                     = 'به‌روزرسانی کارت اعتباری';
$lang['credit_card_update_info']                                = 'آیا می‌خواهید کارت اعتباری که در سیستم ذخیره کرده‌ایم را به‌روزرسانی کنید؟ اطلاعات جدید را در اینجا وارد کنید. اطلاعات کارت شما هیچ‌گاه مستقیماً به سرور ما ارسال نخواهد شد.';
...
$lang['subscription_date']                                      = 'تاریخ اشتراک';
$lang['first_billing_date']                                     = 'تاریخ صدور فاکتور اولیه';
$lang['allow_primary_contact_to_update_credit_card']            = 'اجازه به تماس اصلی برای به‌روزرسانی توکن کارت اعتباری ذخیره‌شده؟';
$lang['show_subscriptions_in_customers_area']                   = 'آیا اشتراک‌ها را در ناحیه مشتریان نمایش دهیم؟';
$lang['show_subscriptions_in_customers_area_help']              = 'این گزینه فقط برای تماس اصلی مشتری معتبر است.';
...
$lang['next_billing_cycle']                                     = 'دوره صدور فاکتور بعدی';
$lang['subscription_not_subscribed']                            = 'مشترک نشده';
$lang['send_subscription']                                      = 'ارسال اشتراک';
$lang['subscription_will_send_to_primary_contact']              = 'اشتراک به تماس اصلی ارسال خواهد شد.';
$lang['subscription_resumed']                                   = 'اشتراک با موفقیت فعال شد';
$lang['subscription_canceled']                                  = 'اشتراک با موفقیت لغو شد';
$lang['no_credit_card_found']                                   = 'کارت اعتباری پیدا نشد';
$lang['cancel_immediately']                                     = 'لغو فوراً';
$lang['cancel_at_end_of_billing_period']                        = 'لغو در پایان دوره صدور فاکتور';
$lang['view_subscription']                                      = 'مشاهده اشتراک';
$lang['subscription_future']                                    = 'آینده';
$lang['subscription_active']                                    = 'فعال';
$lang['subscription_past_due']                                  = 'موجودی معوق';
$lang['subscription_canceled']                                  = 'لغو شده';
$lang['subscription_unpaid']                                    = 'پرداخت نشده';
$lang['billing_plan']                                           = 'طرح صدور صورتحساب';
$lang['upcoming_invoice']                                       = 'فاکتور آینده';
$lang['resume_now']                                             = 'ادامه دادن اکنون';
$lang['subscription_not_yet_subscribed']                        = 'مشتری هنوز به این اشتراک مشترک نشده است.';
$lang['subscription_is_canceled_no_resume']                     = 'این اشتراک لغو شده است و نمی‌توان آن را ادامه داد.';
$lang['subscription_will_be_canceled_at_end_of_billing_period'] = 'این اشتراک در پایان دوره صدور فاکتور لغو خواهد شد.';
$lang['customer_successfully_subscribed_to_subscription']       = 'از اشتراک در %s متشکریم';
$lang['date_subscribed']                                        = 'تاریخ اشتراک';
$lang['reports']                                                = 'گزارش‌ها';
$lang['subscriptions_summary']                                  = 'خلاصه اشتراک‌ها';
$lang['calendar_only_assigned_tasks']                           = 'فقط وظایف اختصاص داده شده به عضو وارد شده را نمایش دهید';
...
$lang['settings_require_client_logged_in_to_view_contract']     = 'نیاز است که مشتری برای مشاهده قرارداد وارد شود';
...
$lang['gdpr']                                                   = 'قوانین حفاظت از داده‌های عمومی (GDPR)';
$lang['data_removal_request_sent']                              = 'درخواست حذف داده‌ها با موفقیت ارسال شد';
$lang['gdpr_consents']                                          = 'رضایت‌نامه‌ها';
$lang['gdpr_consent']                                           = 'رضایت‌نامه';
$lang['gdpr_consent_purpose']                                   = 'هدف';
$lang['gdpr_consent_opt_in']                                    = 'پذیرش';
$lang['gdpr_consent_opt_out']                                   = 'عدم پذیرش';
$lang['gdpr_consent_agree']                                     = 'موافقم';
$lang['gdpr_consent_disagree']                                  = 'مخالفم';
$lang['view_consent']                                           = 'مشاهده رضایت‌نامه';
$lang['transfer_consent']                                       = 'انتقال رضایت‌نامه';
$lang['view_public_form']                                       = 'مشاهده فرم عمومی';
$lang['update_consent']                                         = 'به‌روزرسانی رضایت‌نامه';
$lang['consent_last_updated']                                   = 'آخرین به‌روزرسانی: %s';
$lang['showing_search_result']                                  = 'نمایش نتایج جستجو برای: %s';
$lang['per_page']                                               = 'تعداد در هر صفحه';
$lang['allow_staff_view_invoices_assigned']                     = 'اجازه دهید اعضای تیم فقط فاکتورهایی را مشاهده کنند که به آنها اختصاص داده شده است';
$lang['allow_staff_view_estimates_assigned']                    = 'اجازه دهید اعضای تیم فقط برآوردهایی را مشاهده کنند که به آنها اختصاص داده شده است';
$lang['gdpr_right_to_be_informed']                              = 'حق اطلاع‌رسانی';
$lang['gdpr_right_of_access']                                   = 'حق دسترسی';
$lang['gdpr_right_to_data_portability']                         = 'حق قابلیت حمل داده‌ها';
$lang['gdpr_right_to_erasure']                                  = 'حق حذف داده‌ها';
...
$lang['briefly_describe_why_remove_data']                       = 'به طور خلاصه توضیح دهید چرا می‌خواهید داده‌ها را حذف کنید';
$lang['date_published']                                         = 'تاریخ انتشار';
$lang['view']                                                   = 'مشاهده';
$lang['customer_is_subscribed_to_subscription_info']            = 'مشتری به این اشتراک مشترک شده است';
$lang['save_last_order_for_tables']                             = 'آخرین سفارش برای جداول را ذخیره کن';
$lang['date_created']                                           = 'تاریخ ایجاد';

# Version 2.0.1
$lang['company_logo_dark']                                      = 'لوگوی شرکت (تاریک)';
$lang['customers_register_require_confirmation']                = 'نیاز به تأیید ثبت‌نام از سوی مدیر پس از ثبت‌نام مشتری';
...
$lang['customer_register_account_confirmation_approval_notice'] = 'از ثبت‌نام شما متشکریم، حساب شما در حال بررسی است و به زودی تأیید خواهد شد.';
$lang['after_subscription_payment_succeeded']                   = 'پس از موفقیت‌آمیز بودن پرداخت اشتراک';
...
$lang['subscription_option_do_nothing']                         = 'هیچ کاری انجام ندهید';
$lang['gdpr_not_enabled']                                       = 'GDPR فعال نیست';
$lang['enable_gdpr']                                            = 'فعال‌سازی GDPR';
$lang['gdpr_right_to_rectification']                            = 'حق اصلاح داده‌ها';
$lang['test_sms_config']                                        = 'آزمایش تنظیمات پیامک';
$lang['test_sms_message']                                       = 'پیام آزمایشی';
$lang['send_test_sms']                                          = 'ارسال پیامک آزمایشی';
$lang['gdpr_short']                                             = 'GDPR';
$lang['allow_non_admin_staff_to_delete_ticket_attachments']     = 'اجازه به اعضای تیم غیرمدیر برای حذف پیوست‌های تیکت';

# Version 2.1.0
$lang['contract_number']                                = 'شماره قرارداد';
$lang['project_changing_status_recurring_tasks_notice'] = 'شما در حال تغییر وضعیت به {0} هستید، تمام وظایف دوره‌ای لغو خواهند شد';
$lang['not_contract_signed']                            = 'قرارداد با موضوع %s توسط مشتری امضا شد';
$lang['the_number_sign']                                = '#';
$lang['not_new_ticket_reply']                           = 'مشتری به تیکت پاسخ داد - %s';
$lang['receive_notification_on_new_ticket_replies']     = 'دریافت اعلان هنگام پاسخ مشتری به تیکت';
$lang['receive_notification_on_new_ticket_reply_help']  = 'تمام اعضای تیم که به بخش تیکت تعلق دارند، هنگام پاسخ مشتری به تیکت، اعلان دریافت خواهند کرد';
$lang['payment_gateway_enable_paypal']                  = 'فعال‌سازی پرداخت‌های PayPal';
$lang['project_member']                                 = 'عضو پروژه';
$lang['contract_notes']                                 = 'یادداشت‌ها';
$lang['contract_add_note']                              = 'افزودن یادداشت';
...
$lang['google_picker']                                               = 'انتخاب کننده Google';
$lang['enable_google_picker']                                        = 'فعال‌سازی انتخاب کننده Google';
$lang['google_api_client_id']                                        = 'شناسه کلاینت API گوگل';
$lang['subtract_tax_total_from_amount']                              = 'کسر مجموع مالیات (%s) از مبلغ';
$lang['expense_subtract_info_text']                                  = 'از این گزینه برای کسر مبلغ مالیات از مبلغ هزینه استفاده کنید، مفید است زمانی که شما مبلغ هزینه را با مالیات وارد کرده‌اید (شامل مالیات).';
$lang['company_exists_info']                                         = 'به نظر می‌رسد مشتری با نام %s قبلاً وجود دارد، اگر همچنان می‌خواهید مشتری را ایجاد کنید، می‌توانید این پیام را نادیده بگیرید.';
$lang['import_items']                                                = 'وارد کردن آیتم‌ها';
$lang['total_items_deleted']                                         = 'تعداد کل آیتم‌های حذف شده: %s';
...
$lang['description_in_invoice_item_help']                            = 'مفید است اگر بخواهید اطلاعات اضافی در فاکتور اشتراک گنجانده شود، مانند اینکه این اشتراک شامل چه چیزی است.';
...
$lang['email_verification_required_message_mail']                    = 'ما ایمیلی با دستورالعمل‌های تأیید برای شما ارسال کرده‌ایم، اگر ایمیل را دریافت نکردید، لطفاً پوشه اسپم را بررسی کنید یا روی <a href="%s">اینجا</a> کلیک کنید تا ایمیل تأیید را دوباره ارسال کنیم.';
...
$lang['email_successfully_verified_but_required_admin_confirmation'] = 'ایمیل شما با موفقیت تأیید شد، شما پس از تأیید دستی حساب کاربری توسط مدیر می‌توانید وارد شوید.';
$lang['email_verification_mail_sent_successully']                    = 'ما ایمیلی با دستورالعمل‌های تأیید برای شما ارسال کرده‌ایم';
$lang['create_reminder']                                             = 'ایجاد یادآوری';
$lang['no_reminders_for_this_task']                                  = 'یادآوری برای این وظیفه وجود ندارد';
...
# Version 2.2.1
$lang['customer_files_info_message'] = 'فایل‌های مربوط به پروژه‌ها و وظایف مرتبط با مشتری در این جدول نمایش داده نمی‌شوند.';
$lang['ticket_import_reply_only']    = 'فقط تلاش کنید پاسخ واقعی تیکت (بدون پیام‌های نقل شده/ارسال مجدد) را وارد کنید';
$lang['learn_more']                  = 'اطلاعات بیشتر';
$lang['sales_item']                  = 'آیتم فروش';
...
$lang['module_uninstall']                        = 'حذف ماژول';
...
$lang['staff_which_are_using_role']              = 'اعضای تیمی که از این نقش استفاده می‌کنند';
$lang['copy']                                    = 'کپی';
$lang['read_more']                               = 'بیشتر بخوانید';
$lang['show_less']                               = 'کمتر نشان بده';
...
$lang['refund_amount']                           = 'مقدار بازپرداخت شده';
$lang['not_refunds_found']                       = 'بازپرداختی یافت نشد';
$lang['refunds_applied_cant_delete_credit_note'] = 'این یادداشت اعتباری بازپرداخت‌ها را شامل می‌شود، ابتدا باید بازپرداخت‌ها را حذف کنید تا بتوانید یادداشت اعتباری را حذف کنید.';

# نسخه 2.3.2
$lang['create_recurring_from_child_error_message'] = 'شما نمی‌توانید این %s را به عنوان یک مورد تکراری تنظیم کنید زیرا این %s یک مورد فرزند از یک %s تکراری دیگر است.';
$lang['statement_credit_note_refund']              = 'بازپرداخت یادداشت اعتباری - %s';
$lang['no_validation']                             = 'بدون اعتبارسنجی';
$lang['lead_unique_validation_on']                 = 'اجرای اعتبارسنجی برای پیشگیری از تکراری بودن لید در فیلدهای زیر:';
$lang['phonenumber_exists']                        = 'شماره تلفن قبلاً وجود دارد';
$lang['company_exists']                            = 'شرکت قبلاً وجود دارد';
$lang['website_exists']                            = 'وبسایت قبلاً وجود دارد';
...
$lang['payment_sent_failed']                       = 'ارسال رسید پرداخت با خطا مواجه شد.';

# نسخه 2.3.5
$lang['tags_update_replace_warning'] = 'برخی از برچسب‌ها به‌روزرسانی نشده‌اند زیرا نام برچسب قبلاً وجود دارد';
$lang['attach_statement']            = 'ضمیمه کردن صورت‌حساب مشتری';
...
$lang['subscription_complete_payment']             = 'اتمام پرداخت';
$lang['subscription_is_subscription_is_expired']   = 'این اشتراک منقضی شده است.';
$lang['subscription_plan_currency_does_not_match'] = 'واحد پول طرح انتخابی با واحد پول انتخابی در زیر تطابق ندارد.';
$lang['subscription_first_billing_date_info']      = 'برای استفاده از تاریخ اشتراک مشتری، این قسمت را خالی بگذارید. این تاریخ باید یک تاریخ آینده باشد، اگر تاریخ را انتخاب کرده‌اید و تاریخ گذشته است اما مشتری هنوز مشترک نشده است، تاریخ اشتراک مشتری استفاده خواهد شد.';
$lang['stripe_subscription_select_plan']           = 'طرح Stripe را انتخاب کنید';

# Version 2.4.1
$lang['contract_content_permission_edit_warning'] = 'مجوزهای فعلی شما اجازه ویرایش محتوای قرارداد را نمی‌دهند. لطفاً با یک مدیر مشورت کنید تا اجازه ویرایش قراردادها را دریافت کنید.';
$lang['mark_as_signed']                 = 'علامت‌گذاری به عنوان امضا شده';
$lang['unmark_as_signed']               = 'حذف علامت امضا شده';
$lang['marked_as_signed']               = 'علامت‌گذاری شده به عنوان امضا شده';
...
$lang['schedule']                       = 'برنامه‌ریزی';
$lang['schedule_email_for']             = 'برنامه‌ریزی ایمیل برای %s';
$lang['schedule_date']                  = 'چه زمانی می‌خواهید ایمیل ارسال شود؟';
$lang['email_scheduled_successfully']   = 'ایمیل با موفقیت برنامه‌ریزی شد';
$lang['invoice_will_be_sent_at']        = 'فاکتور در تاریخ %s ارسال خواهد شد';

# Version 2.5.0
$lang['recaptcha_ignore_ips']            = 'آدرس‌های IP نادیده گرفته شده';
$lang['recaptcha_ignore_ips_info']       = 'آدرس‌های IP که می‌خواهید reCaptcha از اعتبارسنجی آن‌ها صرف‌نظر کند، به صورت جدا شده با ویرگول وارد کنید.';
$lang['show_task_reminders_on_calendar'] = 'یادآوری‌های تسک';
$lang['contracts_about_to_expire']       = 'قراردادهایی که به زودی منقضی می‌شوند';
$lang['no_contracts_about_to_expire']    = 'هیچ قراردادی در %s روز آینده منقضی نمی‌شود.';
$lang['lead_value']                      = 'ارزش سرنخ';
$lang['lead_value_tooltip']              = 'واحد پول پایه استفاده خواهد شد.';
$lang['leads_dt_lead_value']             = 'ارزش سرنخ';
$lang['leads_canban_lead_value']         = 'ارزش سرنخ: %s';
$lang['lead_add_edit_lead_value']        = 'ارزش سرنخ';

# Version 2.6.0
$lang['gantt_view_day']   = 'نمایش روزها';
$lang['gantt_view_week']  = 'نمایش هفته‌ها';
$lang['gantt_view_month'] = 'نمایش ماه‌ها';
$lang['gantt_view_year']  = 'نمایش سال‌ها';

# Version 2.7.0
$lang['hour_of_day_perform_tasks_reminder_notification_help'] = 'فرمت 24 ساعته است، مثلاً 9 برای ساعت 9 صبح یا 15 برای ساعت 3 بعد از ظهر. این برای وظایف تکراری، یادآوری‌ها و غیره استفاده می‌شود.';
...
$lang['allow_primary_contact_to_manage_other_contacts']       = 'اجازه دهید مخاطب اصلی سایر مخاطبین مشتری را مدیریت کند';
$lang['contact_form_validation_is_unique']                    = 'مخاطب با این {field} قبلاً در سیستم ما وجود دارد';
$lang['invoice_number_not_applied_on_draft']                  = 'اگر فاکتور به‌عنوان پیش‌نویس ذخیره شود، شماره به آن اعمال نخواهد شد، بلکه شماره فاکتور بعدی هنگامی که فاکتور به مشتری ارسال می‌شود یا به‌عنوان ارسال شده علامت‌گذاری می‌شود، اعمال خواهد شد.';
...
$lang['enter_two_factor_auth_code_from_mobile']      = 'کد احراز هویت را از اپلیکیشن Authenticator وارد کنید';
$lang['staff_two_factor_authentication']             = 'احراز هویت دو مرحله‌ای';
$lang['google_authentication_code']                  = 'کد را از اپلیکیشن Authenticator وارد کنید';
$lang['set_two_factor_authentication_successful']    = 'تنظیمات احراز هویت دو مرحله‌ای با موفقیت به‌روزرسانی شد';
$lang['set_two_factor_authentication_failed']        = 'نتوانستیم تنظیمات احراز هویت دو مرحله‌ای را به‌روزرسانی کنیم';
$lang['google_2fa_code_valid']                       = 'احراز هویت با موفقیت تأیید شد';
$lang['google_2fa_code_invalid']                     = 'کد احراز هویت وارد شده معتبر نیست، لطفاً دوباره تلاش کنید.';
$lang['google_2fa_scan_qr_guide']                    = 'QR کد زیر را با اپلیکیشن Google Authenticator روی دستگاه موبایل خود اسکن کنید، سپس کد تولید شده در اپلیکیشن را در فیلد زیر وارد کنید';
...
$lang['template_added']                              = 'الگو با موفقیت اضافه شد';
$lang['template_updated']                            = 'الگو با موفقیت به‌روزرسانی شد';
$lang['template_name']                               = 'عنوان الگو';
$lang['template_content']                            = 'محتوای الگو';
$lang['insert_template']                             = 'درج الگو';
$lang['items_table_amounts_exclude_currency_symbol'] = 'حذف نماد ارز از مبلغ جدول آیتم‌ها';

$lang['multiplies_of']               = 'برابر با';
$lang['round_off_task_timer_option'] = 'گرد کردن تایمر وظیفه';
$lang['task_timer_dont_round_off']   = 'گرد نکردن';
$lang['task_timer_round_up']         = 'گرد کردن به بالا';
$lang['task_timer_round_down']       = 'گرد کردن به پایین';
$lang['task_timer_round_nearest']    = 'گرد کردن به نزدیک‌ترین';
$lang['calendar_task_reminder']      = 'یادآوری وظیفه';
$lang['projects_chart']              = 'نمودار پروژه‌ها';
$lang['overdue_by_days']             = 'معوق شده به مدت %s روز';

$lang['two_checkout_payment_processing'] = 'پرداخت در حال پردازش است، اگر موفقیت‌آمیز بود به شما اطلاع داده خواهد شد';
$lang['two_checkout_payment_cancelled']  = 'پرداخت لغو شد';
$lang['two_checkout_merchant_code']      = 'کد فروشنده';
$lang['two_checkout_secret_Key']         = 'کد مخفی';
$lang['two_gateway_webhook_notice']      = 'آدرس IPN برای 2Checkout این است: ( %s )';
$lang['something_went_wrong']            = 'مشکلی پیش آمده است. دوباره تلاش کنید';
$lang['imap_folder']                     = 'پوشه';
$lang['retrieve_folders']                = 'دریافت پوشه‌ها';
$lang['email_to_ticket_config']          = 'پیکربندی ایمیل به بلیط';

# Version 2.8.0
$lang['enable_support_menu_badges']              = 'فعال‌سازی نشان‌های منوی پشتیبانی';
...
$lang['estimate_request_notify_staff']                     = 'اعضای تیم برای اطلاع‌رسانی';
$lang['estimate_request_notify_when_submitted']            = 'اطلاع‌رسانی هنگام ارسال درخواست تخمین';
$lang['estimate_request_assignee']                         = 'مسئول (واگذار شده)';
$lang['estimate_request_notify_roles']                     = 'نقش‌هایی که باید اطلاع‌رسانی شوند';
...
$lang['estimate_request_dt_assigned']                      = 'واگذار شده';
...
$lang['estimate_request_table_total']                      = 'تعداد کل درخواست‌ها: %s';
$lang['estimate_request_statuses_not_found']               = 'هیچ وضعیت درخواست تخمینی یافت نشد';
...
$lang['estmate_request_tags_updated']                      = 'برچسب‌ها به‌روزرسانی شد';
...
$lang['estimate_request_form_email_field_set_to_required'] = 'فیلد ایمیل را به‌عنوان الزامی علامت‌گذاری کنید';
...
$lang['estimate_request_for_lead']                         = 'مشتری بالقوه';
$lang['estimate_request_for_customer']                     = 'مشتری';
$lang['estimate_request_related']                          = 'مرتبط با';
$lang['estimate_request_client_created_success']           = 'مشتری درخواست تخمین با موفقیت ایجاد شد';
$lang['estimate_request_assigned']                         = 'کارمند واگذار شد';
$lang['not_estimate_request_activity_assigned_updated']    = 'درخواست تخمین به %s واگذار شد';
$lang['estimate_request_status_lowercase']                 = 'وضعیت درخواست تخمین';
$lang['estimate_request_assigned_to_staff']                = 'درخواست تخمین به شما واگذار شد';

$lang['activity_due_reminder_is_sent']   = '%s یادآوری مهلت رسیدن فاکتور را ارسال کرد';
$lang['invoice_due_notice_before']       = 'ارسال یادآوری مهلت پرداخت X روز قبل از تاریخ سررسید';
$lang['overdue_notices']                 = 'یادآوری‌های سررسید گذشته';
$lang['invoice_overdue_notices_info']    = 'یادآوری‌های سررسید گذشته زمانی ارسال می‌شوند که فاکتور سررسید گذشته باشد.';
$lang['due_reminders']                   = 'یادآوری‌های سررسید';
$lang['due_reminders_for_invoices_info'] = 'یادآوری‌های سررسید برای فاکتورهای پرداخت نشده و پرداخت جزئی ارسال می‌شود تا به مشتری یادآوری کند که قبل از تاریخ سررسید، فاکتور را پرداخت کند.';
$lang['expenses_list_made_payment_by']   = 'پرداخت شده توسط %s';

# Version 2.8.2
$lang['hide_task_checklist_items_completed'] = 'پنهان کردن آیتم‌های تکمیل‌شده';
$lang['show_task_checklist_items_completed'] = 'نمایش آیتم‌های تکمیل‌شده %s';
$lang['task_checklist_assign']               = 'اختصاص به کارکنان';
$lang['task_checklist_assigned']             = 'اختصاص داده شده به %s';

# Version 2.8.3
$lang['projects_send_contact_notification']                   = 'ارسال اطلاع‌رسانی به مخاطبین';
$lang['project_send_all_contacts_with_notifications_enabled'] = 'برای تمام مخاطبینی که اطلاع‌رسانی پروژه‌ها برای آنها فعال است';
$lang['project_do_not_send_contacts_notifications']           = 'ارسال اطلاع‌رسانی ارسال نشود';
...
$lang['show_estimate_request_in_customers_area']              = 'آیا لینک درخواست برآورد در منطقه مشتری نمایش داده شود؟';
$lang['customers_estimate_request_link_text']                 = 'درخواست برآورد';
$lang['total_expenses_deleted']                               = 'مجموع هزینه‌های حذف شده: %s';
$lang['estimate_convert_to_project']                          = 'تبدیل به پروژه';
$lang['estimate_items_convert_to_tasks']                      = 'آیتم‌هایی که به تسک تبدیل خواهند شد';

# Version 2.9.0
$lang['home_payment_records']                                  = 'سوابق پرداخت';
$lang['weekly']                                                = 'هفتگی';
$lang['monthly']                                               = 'ماهانه';
$lang['failed_to_update_timesheet']                            = 'بروزرسانی تایم‌شیت با شکست مواجه شد';
$lang['permission_create_timesheets']                          = 'ایجاد تایم‌شیت';
$lang['permission_edit_timesheets']                            = 'ویرایش تایم‌شیت (سراسری)';
$lang['permission_edit_own_timesheets']                        = 'ویرایش تایم‌شیت خود';
$lang['permission_delete_timesheets']                          = 'حذف تایم‌شیت (سراسری)';
$lang['permission_delete_own_timesheets']                      = 'حذف تایم‌شیت خود';
$lang['permission_edit_milestones']                            = 'ویرایش مایل‌استون‌ها';
$lang['permission_delete_milestones']                          = 'حذف مایل‌استون‌ها';
$lang['add_timesheet']                                         = 'اضافه کردن تایم‌شیت';
$lang['submit_button_bg_color']                                = 'رنگ پس‌زمینه دکمه ارسال';
$lang['submit_button_text_color']                              = 'رنگ متن دکمه ارسال';
$lang['automatically_assign_ticket_to_first_staff_responding'] = 'آیا به طور خودکار بلیط را به اولین کارمندی که پاسخ می‌دهد اختصاص دهید؟';


# Version 2.9.1
$lang['contract_signed_not_all_fields_editable'] = 'این قرارداد امضا شده است، بنابراین تا زمانی که امضا حذف نشود، نمی‌توان تمام فیلدها را ویرایش کرد.';
...
$lang['form_submit_success_redirect_to_website'] = 'انتقال به وب‌سایت دیگر';
$lang['form_submit_website_url']                 = 'آدرس وب‌سایت';

# Version 2.9.2
$lang['open_google_map']                                  = 'باز کردن در نقشه گوگل';
$lang['milestone_start_date']                             = 'تاریخ شروع';
$lang['send_reminder_for_completed_but_not_billed_tasks'] = 'ارسال یادآور ایمیل برای وظایف تکمیل‌شده اما فاکتور نشده';
$lang['staff_to_notify_completed_but_not_billed_tasks']   = 'انتخاب اعضای کادر که می‌خواهید یادآور برای آن‌ها ارسال شود';
$lang['reminder_for_completed_but_not_billed_tasks_days'] = 'انتخاب روزهای هفته‌ای که یادآور باید ارسال شود';
$lang['notifications']                                    = 'اعلان‌ها';
$lang['merged']                                           = 'ادغام شده';
$lang['ticket_merged_notice']                             = 'این تیکت به تیکت با شناسه ID ادغام شده است';
...
$lang['merge_ticket_ids_field_label']                     = 'ادغام تیکت شماره';
$lang['merge_ticket_ids_field_placeholder']               = 'مثال: ۵ یا ۵،۶';
...
$lang['batch_payments_table_amount_received_heading']     = 'مبلغ دریافتی';
$lang['batch_payments_table_invoice_balance_due']         = 'مبلغ باقی‌مانده فاکتور';
$lang['add_batch_payments']                               = 'اضافه کردن پرداخت‌های دسته‌ای';
$lang['batch_payment_filter_by_customer']                 = 'فیلتر فاکتورها بر اساس مشتری';
$lang['batch_payments']                                   = 'پرداخت‌های دسته‌ای';
$lang['batch_payment_added_successfully']                 = 'شما با موفقیت %s پرداخت را اضافه کردید';
$lang['batch_payments_send_invoice_payment_recorded']     = 'ایمیل ثبت پرداخت فاکتور به مخاطبان مشتری ارسال نشود';
$lang['invoice_batch_payments']                           = 'پرداخت دسته‌ای فاکتور';
$lang['staff_is_currently_replying']                      = '%s در حال پاسخ دادن به تیکت است';

# Version 2.9.4
$lang['permission_view_timesheet_report']                  = 'مشاهده گزارش تایم‌شیت‌ها';
$lang['timesheets_overview_all_members_notice_permission'] = 'نمای کلی تایم‌شیت‌ها برای تمام اعضای کادر فقط برای کارکنانی که دسترسی به گزارش تایم‌شیت دارند و مدیران در دسترس است.';
$lang['show_project_on_proposal']                          = 'نمایش نام پروژه در پیشنهاد';
$lang['ticket_reports_staff']                              = 'عضو کادر';
$lang['ticket_reports_total_assigned']                     = 'تعداد تیکت‌های اختصاص داده شده';
...
$lang['ticket_reports_average_reply_time']                 = 'زمان متوسط پاسخ';
$lang['home_tickets_report']                               = 'گزارش تیکت‌های کارکنان';
$lang['ticket_reports_average_reply_time_help']            = 'زمان متوسط پاسخ از تیکت‌های اختصاص داده شده.';
$lang['created_by']                                        = 'ایجاد شده توسط';

$lang['staff_related_ticket_notification_to_assignee_only']      = 'ارسال اعلان‌های مربوط به تیکت به مسئول تیکت فقط';
$lang['staff_related_ticket_notification_to_assignee_only_help'] = 'اگر این گزینه بر روی "بله" تنظیم شود و تیکت مسئول نداشته باشد، اعلان به تمامی اعضای کادر که به دپارتمان تیکت مربوط هستند ارسال خواهد شد';
...
# Version 3.0.0
$lang['contracts_view_marked_as_signed'] = 'علامت‌گذاری شده به‌عنوان امضاء شده';
$lang['contracts_view_signed']           = 'امضاء شده';
$lang['contracts_view_not_expired']      = 'منقضی نشده';
$lang['contract_information']            = 'اطلاعات قرارداد';
$lang['receipt']                         = 'رسید';
$lang['search_proposals']                = 'جستجوی پیشنهادات';
$lang['search_estimates']                = 'جستجوی برآوردها';
$lang['quick_create']                    = 'ایجاد سریع';

# Version 3.0.5
$lang['subscription_last_sent'] = 'آخرین ارسال';
$lang['automatically_set_logged_in_staff_sales_agent'] = 'به‌طور خودکار کارمند وارد شده را به‌عنوان نماینده فروش تنظیم کن';
$lang['automatically_set_logged_in_staff_sales_agent_help'] = 'قابل اعمال برای: برآوردها، فاکتورها، پیشنهادات';
$lang['permission_view_all_templates'] = 'مشاهده تمام الگوها';
$lang['settings_contract_sign_reminder_every_days_info'] = 'یادآوری‌های امضاء پس از اولین ارسال قرارداد به مشتری برای تماس‌های مشتری ارسال می‌شوند و به‌طور خودکار زمانی که قرارداد امضاء شود متوقف می‌شوند.';
$lang['contract_sign_reminder_every_days'] = 'ارسال یادآوری امضاء هر (تعداد روز)';
$lang['contract_sign_reminders'] = 'یادآوری‌های امضاء';
...
$lang['filter_share'] = 'آیا می‌خواهید این فیلتر را با سایر اعضای تیم به اشتراک بگذارید؟';
$lang['filter_mark_as_default'] = 'به‌عنوان پیش‌فرض علامت‌گذاری کن';
$lang['filter_unmark_as_default'] = 'علامت پیش‌فرض را بردار';
$lang['filter_save'] = 'ذخیره فیلتر';
$lang['filter_name'] = 'نام فیلتر';
$lang['filter_apply'] = 'اعمال';
$lang['filter_apply_and_save'] = 'اعمال و ذخیره';
$lang['filter_use_dynamic_dates'] = 'استفاده از تاریخ‌های دینامیک';
...
$lang['filter_cannot_be_shared'] = 'این فیلتر نمی‌تواند با سایر اعضای تیم به اشتراک گذاشته شود زیرا حاوی قوانینی است که ممکن است برای تمام کاربران در دسترس نباشد.';
$lang['filter_add_rule'] = 'اضافه کردن قانون';

$lang['filter_operator_is_empty'] = 'ناشناخته';
$lang['filter_operator_is_not_empty'] = 'شناخته شده';
$lang['filter_operator_equal'] = 'مساوی';
$lang['filter_operator_not_equal'] = 'مساوی نیست';
...
$lang['filter_operator_not_in'] = 'در نیست';
$lang['filter_operator_between'] = 'بین';
$lang['filter_operator_not_between'] = 'بین نیست';
$lang['filter_operator_dynamic'] = 'دینامیک';
$lang['filter_operator_greater'] = 'بزرگتر';
$lang['filter_operator_greater_or_equal'] = 'بزرگتر یا مساوی';
$lang['filter_operator_less'] = 'کوچکتر';
$lang['filter_operator_less_or_equal'] = 'کوچکتر یا مساوی';
$lang['no_filters_found'] = 'فیلتر ذخیره‌شده‌ای پیدا نشد، برای شروع یک فیلتر جدید بسازید.';

$lang['staff_logged_in_public_ticket_warning'] = 'شما به‌عنوان یک عضو کادر پشتیبانی وارد شده‌اید. اگر می‌خواهید به تیکت به‌عنوان کادر پشتیبانی پاسخ دهید، باید پاسخ را از طریق بخش مدیریت ارسال کنید.';

# Version 3.1.2
$lang['allow_non_admin_members_to_delete_tickets_and_replies'] = 'اجازه به اعضای غیرمدیر برای حذف تیکت‌ها و پاسخ‌ها';
$lang['default_filter_info'] = 'فیلتر فقط برای حساب شما به‌عنوان پیش‌فرض علامت‌گذاری خواهد شد.';
$lang['required_register_fields'] = 'فیلدهای ضروری برای ثبت‌نام (منطقه مشتریان)';

# Version 3.1.6
$lang['allow_non_admin_members_to_edit_ticket_messages'] = 'اجازه به اعضای غیرمدیر برای ویرایش پیام‌های تیکت';
$lang['proposal_auto_convert_to_invoice_on_client_accept'] = 'تبدیل خودکار پیشنهاد به فاکتور پس از پذیرش مشتری (فقط برای پیشنهادات مربوط به مشتریان)';
$lang['invoice_activity_auto_converted_from_proposal'] = 'فاکتور به‌طور خودکار از پیشنهاد با شماره %s ایجاد شد';
$lang['clients_proposal_invoiced_successfully'] = 'از شما برای پذیرش پیشنهاد متشکریم. لطفاً فاکتور ایجاد شده برای پیشنهاد را بررسی کنید';

# Version 3.2.0
$lang['ideal_payment_failure_message'] = 'پرداخت ناموفق بود یا لغو شد.';
$lang['ideal_api_publishable_key'] = 'کلید منتشر شده استریپ';
$lang['ideal_api_secret_key'] = 'کلید مخفی API استریپ';
$lang['filters'] = 'فیلترها';
$lang['view_financial_stats'] = 'مشاهده آمار مالی';
$lang['timesheet_summary'] = 'خلاصه تایم‌شیت';
$lang['timesheet_detailed_overview'] = 'بررسی دقیق تایم‌شیت‌ها و ساعت‌های ثبت‌شده';
$lang['ticket_request_history'] = 'تاریخچه درخواست‌ها';
$lang['integrations'] = 'یکپارچه‌سازی‌ها';
$lang['settings_group_other'] = 'سایر تنظیمات';
$lang['settings_group_configure_features'] = 'پیکربندی ویژگی‌ها';
$lang['disable_ticket_public_url'] = 'غیرفعال کردن URL عمومی تیکت';

# Version 3.2.1
$lang['ideal_gateway_keys_not_configured'] = 'کلیدهای درگاه پرداخت iDEAL پیکربندی نشده است.';
$lang['ideal_gateway_cannot_be_activated_keys_not_configured'] = 'درگاه پرداخت iDEAL نمی‌تواند فعال شود زیرا کلید Publishable/API استریپ پیکربندی نشده است.';
$lang['company_logo_light'] = 'لوگوی روشن شرکت';
